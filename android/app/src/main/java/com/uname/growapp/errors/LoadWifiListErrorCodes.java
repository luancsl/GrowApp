package com.uname.growapp.errors;
...
public enum LoadWifiListErrorCodes {
    ...
    /**
     * Starting Android 6, location services needs to be on to scan for wifi
     * networks.
     */
    locationServicesOff,
    /**
    ...
    /**
     * An exception caused by JS requesting the UI manager to perform an illegal
     * view operation.
     */
